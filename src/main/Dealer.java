...
*/
  public class Dealer 
    {
	ArrayList<PokerCard> hand;//represents the dealer's hand
	private int handvalue=0;//value of the dealer's hand (starts at 0)
	private PokerCard[] aHand;//used to convert the dealer's hand to an array
...
*/
	public void showFirstCard()
		{
		PokerCard[] firstCard = new PokerCard[]{};
		firstCard = hand.toArray(firstCard);
		System.out.println("["+firstCard[0]+"]");
		}
/*
* Gives the dealer another card and updates the value of his hand. 
* Takes into account the value of aces.
*/
